...
public class Game : MonoBehaviour {
	...
	void Update () {
        ...
        var hero = GameObject.Find("Hero/Sprite");
        var heroLabel = GameObject.Find("HeroPositionLabel").GetComponent<GUIText>();
        heroLabel.text = "hero position: " + hero.transform.position;
    }
}
